...
public class BannerLayout extends RelativeLayout {
    ...
    private int selectedIndicatorHeight = 16;
    private int selectedIndicatorWidth = 16;
    private int unSelectedIndicatorHeight = 16;
    private int unSelectedIndicatorWidth = 16;
